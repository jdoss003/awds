...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener((view) -> {
                Snackbar.make(view, "Scan Bar Code(Will integrate in near future.)", Snackbar.LENGTH_LONG)
        ...
        //new GetDataTask().execute("http:169.235.178.211:1000/api/status"); //school
    ...
    class PostDataTask extends AsyncTask<String, Void, String> {
        ...
        private String postData(String urlPath)throws IOException, JSONException {
            ...
            try {
                ...
                dataToSend.put("firstname", "Pluto");
                dataToSend.put("lastname", "Mars");

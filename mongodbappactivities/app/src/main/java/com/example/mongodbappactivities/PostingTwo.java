...
public class PostingTwo extends AppCompatActivity {
    ...
    class PostDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PostingTwo.this);
        ...
        private String postData(String urlPath)throws IOException, JSONException {
            ...
            try {
                ...
                dataToSend.put("firstname", "Blue");
                dataToSend.put("lastname", "Sky");
